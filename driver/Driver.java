/*  Driver.java
    A simple driver to test program #1 Generic_ArrayPriorityQueue 
    CS310 Spring 2018
*/
...
public class Driver {
    ...
    private void test1() {
        ...
        for(int i=0; i < SIZE; i++) 
            if(!pq.insert(array[i]))// if fail to insert, test fails
...
//////////////////////////////////////////////////////////////////////////////       
    ...
    private void test4() {
        ...
        System.out.println("NOTE: No specific order is required for this printout.");
        
        // Inserting Priority Item
        for(int i=0; i < 3; i++)
            pq2.insert(new PrioritizedItem(10,sequenceNumber++));
        for(int i=0; i < 3; i++)
            pq2.insert(new PrioritizedItem(3,sequenceNumber++));
        for(int i=0; i < 3; i++)
            pq2.insert(new PrioritizedItem(1,sequenceNumber++));    
        for(int i=0; i < 3; i++)
        ...
        System.out.println("Passed test #4, priority check");
    }
    ...
    private void test5() {
        ...
        System.out.println("Passed test #5, order check");
    }
